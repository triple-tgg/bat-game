  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="card w-full max-w-md">
        ...
        <p className="mt-6 text-center text-xs text-gray-400">ถ้ายังไม่มีบัญชี ระบบจะสร้างให้อัตโนมัติ</p>
        ...
        <div className="mt-6 rounded-lg bg-gray-50 border border-gray-200 p-4">
          ...
          <div className="space-y-1 text-xs text-gray-500">
            <div className="flex justify-between"><span>สมชาย (Admin)</span><span className="font-mono">0800000001</span></div>
            <div className="flex justify-between"><span>สมหญิง (Platinum)</span><span className="font-mono">0800000002</span></div>
            <div className="flex justify-between"><span>อดิศร (Gold)</span><span className="font-mono">0800000005</span></div>
          </div>
        </div>
      </div>
    </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="flex min-h-[80vh] items-center justify-center"><div className="animate-pulse text-gray-400">กำลังโหลด...</div></div>}>
      <LoginForm />
    </Suspense>
  );
}
